class UserInfosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_info.save
        format.html { redirect_to  atm_machine_path(session[:my_atm]), notice: 'User info was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @user_info.update(user_info_params)
        format.html { redirect_to  atm_machine_path(session[:my_atm]), notice: 'User info was successfully updated.' }
